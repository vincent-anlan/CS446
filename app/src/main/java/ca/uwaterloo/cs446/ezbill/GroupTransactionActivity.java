...
//        });
        ...
        Participant p1 = new Participant("U1", "name1");
        select_participants.add(p1);
        Participant p2 = new Participant("U2", "name2");
        select_participants.add(p2);
        Participant p3 = new Participant("U3", "name3");
        select_participants.add(p3);
        Participant p4 = new Participant("U4", "name4");
    ...
    public void saveButtonHandler(View v) {
        ...
        Participant payer = new Participant("123", mSelectPayer.getSelectedItem().toString());
        GroupTransaction newGroupTransaction = new GroupTransaction(transactionCreator, payer, select_participants);
