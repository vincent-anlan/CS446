    ...
    public void setPayerSelector() {
        ...
        mSelectPayer.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(GroupUpsert.this, "Selected:" + selectedvalue, Toast.LENGTH_SHORT).show();
    ...
    public void setPaticipantAutoSum() {
        ...
        mParticipant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder mBuilder = new AlertDialog.Builder(GroupUpsert.this);
                ...
                mBuilder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        for (int i = 0; i < collect.size(); i++) {
                            ...
                            TextView btn = new TextView(GroupUpsert.this);
                            btn.setText(item);
                            btn.setTextSize(25);
                            btn.setLayoutParams(params);
                            btn.setGravity(Gravity.START);

                            EditText subExpense = new EditText(GroupUpsert.this);
                            ...
                            LinearLayout linearLayout_h = new LinearLayout(GroupUpsert.this);
